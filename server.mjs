...
const server = http.createServer(async (req, res) => {
    try {
        ...
        if (['/ea-shield.png', '/apple-touch-icon.png', '/share-preview.jpg', '/waterfront.mp4', '/waterfront.jpg', '/tutorial.mp4', '/product.png', '/report.png', '/overview.pdf', '/tutorial.vtt','/home-watch-checklist.txt','/arrival-preparation-checklist.txt','/sample-inspection-report.pdf'].includes(url.pathname)) {
